...
var socket = new _phoenix.Socket("wss://7e4ca7d8.ngrok.io/socket", { params: { user_id: randy } });

socket.connect();

var site = socket.channel("site:" + $domain, {code: window.$BEAM_CODE});

// var handleJoin = function handleJoin(obj) {
//     if (obj !== undefined) {
//         count += obj.metas.length;
//         render(count);
//     }
// };
// var handleLeave = function handleLeave(obj) {
//     if (obj !== undefined) {
//         count -= obj.metas.length;
//         render(count);
//     }
...
// var render = function render(count) {
//     countNode.textContent = count;
// };

// site.on("presence_state", function (state) {
//     count = state.len;
//     render(count);
// });
// site.on("presence_diff", function (diff) {
//     var p = _phoenix.Presence.syncState(presences, diff);
//     var joins = p.joins[Object.keys(p.joins)];
//     var leaves = p.leaves[Object.keys(p.leaves)];

//     handleJoin(joins);
//     handleLeave(leaves);
// });
site.join().receive("ok", function (resp) {
